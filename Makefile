...
publish-windows: platform-windows
	test -n "$(OTP)" && cd npm/esbuild-windows-64 && npm publish --access public --otp="$(OTP) --tag lynx"

publish-windows-32: platform-windows-32
	test -n "$(OTP)" && cd npm/esbuild-windows-32 && npm publish --access public --otp="$(OTP) --tag lynx"

publish-windows-arm64: platform-windows-arm64
	test -n "$(OTP)" && cd npm/esbuild-windows-arm64 && npm publish --access public --otp="$(OTP) --tag lynx"

publish-android: platform-android
	test -n "$(OTP)" && cd npm/esbuild-android-64 && npm publish --access public --otp="$(OTP) --tag lynx"
...
publish-darwin: platform-darwin
	test -n "$(OTP)" && cd npm/esbuild-darwin-64 && npm publish --access public --otp="$(OTP) --tag lynx"
...
publish-freebsd: platform-freebsd
	test -n "$(OTP)" && cd npm/esbuild-freebsd-64 && npm publish --access public --otp="$(OTP) --tag lynx"
...
publish-netbsd: platform-netbsd
	test -n "$(OTP)" && cd npm/esbuild-netbsd-64 && npm publish --access public --otp="$(OTP) --tag lynx"

publish-openbsd: platform-openbsd
	test -n "$(OTP)" && cd npm/esbuild-openbsd-64 && npm publish --access public --otp="$(OTP) --tag lynx"

publish-linux: platform-linux
	test -n "$(OTP)" && cd npm/esbuild-linux-64 && npm publish --access public --otp="$(OTP) --tag lynx"

publish-linux-32: platform-linux-32
	test -n "$(OTP)" && cd npm/esbuild-linux-32 && npm publish --access public --otp="$(OTP) --tag lynx"
...
publish-linux-mips64le: platform-linux-mips64le
	test -n "$(OTP)" && cd npm/esbuild-linux-mips64le && npm publish --access public --otp="$(OTP) --tag lynx"

publish-linux-ppc64le: platform-linux-ppc64le
	test -n "$(OTP)" && cd npm/esbuild-linux-ppc64le && npm publish --access public --otp="$(OTP) --tag lynx"
...
publish-sunos: platform-sunos
	test -n "$(OTP)" && cd npm/esbuild-sunos-64 && npm publish --access public --otp="$(OTP) --tag lynx"
